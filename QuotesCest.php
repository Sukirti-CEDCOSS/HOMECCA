...
class QuotesCest
{
    ...
    {$I->amOnPage('/login');
        ...
        $I->wait(1);
        $I->click("//button[normalize-space()='Create a Quote']");
        $I->wait(2);
        $I->see('New Quote', "//button[normalize-space()='New Quote']");
        $I->seeElement("//img[@alt='Profile Image']");
        $I->seeElement("//label[normalize-space()='Upload company logo']");
        ...
        $I->fillField("//input[@placeholder='Type quote number']",'QT-001');
        $I->fillField("//input[@placeholder='Type your ABN/ACN']",'53930548027');
        $I->fillField("//input[@placeholder='Type reference number']",'48027');
        $I->wait(1);
        $I->scrollTo("//div[@class='he-build-com__details-col he-build-com__left-col']//label[contains(text(),'Address')]");
        $I->wait(1);
        ...
        $I->wait(1);
        $I->fillField("//input[@placeholder='Type quote title']",'This is Quote Title');
        $I->wait(1);
        ...
        $I->wait(2);
        $I->click("//input[@placeholder='Write name']");
        $I->wait(1);
        $I->fillField('//*[@id="create-daily-task-form"]/div[1]/input','Foundation');
        $I->wait(1);
        // $I->click("//select[@id='parent_id']");
        // $I->wait(1);
        // $I->fillField('//*[@id="create-daily-task-form"]/div[1]/input','Foundation');
        // $I->wait(1);
        ...
        $I->click("//tbody/tr/td[5]/span[1]");
        $I->wait(1);
        $I->fillField("//input[@placeholder='Add Quantity']",'15');
        $I->wait(1);
        ...
        $I->click("//tbody/tr/td[7]/span[1]");
        $I->wait(1);
        $I->fillField("//input[@placeholder='Add Discount']",'10');
        $I->wait(1);
        ...
        $I->wait(1);
        $I->click("//a[normalize-space()='Upload']");
        $I->wait(1);
        $I->attachFile("/html/body/div[1]/div/section[2]/div/div[2]/div[2]/div[3]/form/div/div[6]/div[1]/div/div[2]/div/div/label/label/input", 'mb.jpg');
        $I->wait(1);
        $I->fillField("//input[@placeholder='Type your full name']","Sukirti Belaura");
        $I->wait(1);
        $I->fillField("//input[@placeholder='Type your position']","QA");
        $I->wait(1);
        $I->fillField("//input[@placeholder='Type your company']","Homecca");
        $I->wait(1);
        // $I->attachFile("/html/body/div[1]/div/section[2]/div/div[2]/div[2]/div[4]/div/div[1]/p/label", '5mb.pdf');
        $I->wait(1);
        ...
        $I->wait(2);
        $I->waitForText("This will permanently remove your quote from the list. This can not be undone.", 30);
        $I->see('This will permanently remove your quote from the list. This can not be undone.', "//span[contains(text(),'This will permanently remove your quote from the l')]");
        $I->wait(2);
