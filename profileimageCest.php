...
class profileimageCest
{
    ...
    {
        // This Code is to run when you haven't upoaded any profile pic or cover pic yet
        ...
        // //.....Zoom out feature
        // $I->click("//div[@role='dialog']//li[1]//a[1]//*[local-name()='svg']");
        // $I->click("//div[@role='dialog']//li[1]//a[1]//*[local-name()='svg']");
        // $I->click("//div[@role='dialog']//li[1]//a[1]//*[local-name()='svg']");
        // $I->click("//div[@role='dialog']//li[1]//a[1]//*[local-name()='svg']");
        // $I->click("//div[@role='dialog']//li[1]//a[1]//*[local-name()='svg']");
        ...
        // //.......Zoom in Feature
        // $I->click("//div[@role='dialog']//li[3]//a[1]//*[local-name()='svg']");
        // $I->click("//div[@role='dialog']//li[3]//a[1]//*[local-name()='svg']");
        // $I->click("//div[@role='dialog']//li[3]//a[1]//*[local-name()='svg']");
        // $I->click("//div[@role='dialog']//li[3]//a[1]//*[local-name()='svg']");
        // $I->wait(2);
        ...
        // // Image fit feature
        // $I->click("//div[@role='dialog']//li[2]//a[1]//*[local-name()='svg']//*[name()='path' and contains(@fill-rule,'evenodd')]");
        // $I->wait(2);
        
        // //.....Rotate left feature....
        // $I->click("//div[@role='dialog']//li[4]//a[1]//*[local-name()='svg']");
        // $I->wait(2);
        
        // //.....Rotate right freature....
        // $I->click("//div[@role='dialog']//li[5]//a[1]//*[local-name()='svg']");
        // $I->wait(2);


        // //......Delete Image......
        // $I->click("//div[@role='dialog']//li[6]//a[1]//*[local-name()='svg']//*[name()='path' and contains(@fill-rule,'evenodd')]");
        // $I->wait(3);
        
        // //......Save image feature.....
        // $I->click("//img[@src='http://localhost/images/default/Homecca_Avatar-_female.png']");
        // $I->wait(2);
