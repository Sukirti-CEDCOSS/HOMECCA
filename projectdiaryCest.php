...
class projecthubCest
{
    ...
    public function tryToTest(AcceptanceTester $I)
    {
        ...
        $I->seeElement("//div[@class='he-body-content']//ul[2]//li[1]//a[1]//*[local-name()='svg']//*[name()='path' and contains(@fill-rule,'evenodd')]");
        // $I->seeElement("//div[@class='he-project-diary-wrap']//li[2]//a[1]//*[local-name()='svg']//*[name()='path' and contains(@fill-rule,'evenodd')]");
        // $I->seeElement("//*[name()='path' and contains(@d,'M5.01142 1')]");
